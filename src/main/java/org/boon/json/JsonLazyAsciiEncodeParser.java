...
public class JsonLazyAsciiEncodeParser {
        ...
        private JsonLazyAsciiEncodeParser () {

        }

        private JsonLazyAsciiEncodeParser (boolean encodeStrings) {

        }

        public static Object parse ( String cs ) {
            JsonLazyAsciiEncodeParser p = new JsonLazyAsciiEncodeParser ();
            return p.decode ( cs );
        ...
        private Value decodeNumber () {
            ...
            ValueInByteArray value = new ValueInByteArray ();
        ...
        private Value decodeString () {
            ValueInByteArray value = new ValueInByteArray ( Type.STRING );
