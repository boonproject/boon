...
public class CoffeeApp implements Runnable {
    ...
    @Inject Sugar sugar;
    @Inject Bacon bacon;
    @Inject @Named("brown")Bacon brownBacon;
    @Inject @Named("french") Food frenchFood;
    @Inject @Named("american") Food americanFood;

    @Inject @Named("new york") Food newYorkFood;


    @Inject @Named("rick's habit") Food rickDrinks;
    ...
    public static void main(String... args) {
        ...
        Module m7 = ContextFactory.suppliers( supplierOf("brown", Bacon.class, new Supplier<Bacon>() {
            @Override
            public Bacon get() {
